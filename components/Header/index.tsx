...
export default function index() {
    return (
        <div className="relative">
            <div className="absolute top-0 h-20 w-full bg-white rounded-b-full p-3">
                <div className="flex justify-between items-center">
                    ...
                    <div className="bg-gray-200 h-10 w-96 rounded-full flex justify-between items-center">
                        {/* <p className="text-xs mr-3">نام خودرو</p> */}
                        <input
                            type="text"
                            className="bg-transparent outline-none mr-5 placeholder-black text-sm"
                            placeholder="نام خودرو"
                        />
                        <div className="w-40 h-10 bg-black rounded-full flex justify-between text-center items-center">
                            {/* <p className="text-xs text-white mr-3">انتخاب شهر</p> */}
                            <input
                                type="text"
